...
# # # Load dataset
# # df = pd.read_csv(r"C:\Users\akaft\OneDrive\Desktop\NIT@AFTAB\Classroom\MAY@2025\ML_APR_MAY\Ensamble_Learning\21st, 22nd - ENSAMBLE LEARNING\21st, 22nd - ENSAMBLE LEARNING\CHURN MODELING- TF\Churn_Modelling.csv")
...
model = MLPClassifier(hidden_layer_sizes=(6, 6, 5, 4), max_iter=300, random_state=0)
